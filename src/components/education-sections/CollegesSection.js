            ...
            <div className="colleges-grid">
              ...
              <div className="colleges-form-group">
                ...
                <input
                  type="month"
                  className="colleges-input"
                  value={college.datesAttended?.from}
                  onChange={(e) => handleArrayChange('colleges', 'collegesList', index, 'datesAttended', {
                    ...college.datesAttended,
                    from: e.target.value
                  })}
                />
              </div>
              ...
              <div className="colleges-form-group">
                ...
                <input
                  type="month"
                  className="colleges-input"
                  value={college.datesAttended?.to}
                  onChange={(e) => handleArrayChange('colleges', 'collegesList', index, 'datesAttended', {
                    ...college.datesAttended,
                    to: e.target.value
                  })}
