...
const REQUIRED_FIELDS = ['addressLine1', 'city', 'state', 'zipCode', 'country'];
...
const AddressSection = ({ 
  ...
  useEffect(() => {
    ...
    const sectionErrors = ['addressLine1', 'addressLine2', 'city', 'state', 'zipCode', 'country']
      .some(field => fieldErrors[field]);
    setIsFormValid(allFieldsFilled && !sectionErrors);
  ...
  const validateField = (name, value) => {
    ...
    return validateProfileField(name, trimmedValue, formData);
  };
        ...
        <div className="form-group">
          ...
          <div className="input-container">
            <input
              ...
              className={getFieldError('addressLine2') ? 'error' : ''}
            />
          ...
          {getFieldError('addressLine2') && (
            <div className="error-message">{getFieldError('addressLine2')}</div>
          )}
        </div>
