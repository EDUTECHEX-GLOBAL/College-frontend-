...
// 1️⃣  SEGMENTS  — shown as filter chips in Step 3 & Step 4
const SEGMENTS = {
  UG: [
    { id: 'ug-engineering',  name: 'Engineering & Technology' },
    { id: 'ug-computer',     name: 'Computer & IT'            },
    { id: 'ug-science',      name: 'Science'                  },
    { id: 'ug-commerce',     name: 'Commerce & Business'      },
    { id: 'ug-arts',         name: 'Arts & Humanities'        },
    { id: 'ug-medical',      name: 'Medical & Healthcare'     },
    { id: 'ug-law',          name: 'Law'                      },
    { id: 'ug-education',    name: 'Education'                },
    { id: 'ug-design',       name: 'Design & Creative'        },
    { id: 'ug-hospitality',  name: 'Hospitality & Tourism'   },
    { id: 'ug-agriculture',  name: 'Agriculture & Allied'     },
  ],
  PG: [
    { id: 'pg-engineering',  name: 'Engineering & Technology' },
    { id: 'pg-computer',     name: 'Computer & IT'            },
    { id: 'pg-science',      name: 'Science'                  },
    { id: 'pg-business',     name: 'Business & Management'    },
    { id: 'pg-arts',         name: 'Arts & Humanities'        },
    { id: 'pg-medical',      name: 'Medical & Healthcare'     },
    { id: 'pg-law',          name: 'Law'                      },
    { id: 'pg-education',    name: 'Education'                },
    { id: 'pg-design',       name: 'Design & Creative'        },
    { id: 'pg-hospitality',  name: 'Hospitality & Tourism'   },
    { id: 'pg-agriculture',  name: 'Agriculture & Allied'     },
  ],
};

// 2️⃣  COURSES_BY_PROGRAM  — shown as quick-select chips in Step 3
//     UG = Bachelor courses | PG = Master courses  (sourced from your PDF)
const COURSES_BY_PROGRAM = {
  UG: {
    "Engineering & Technology": [
      "B.Tech", "BE", "B.Tech CSE", "B.Tech IT", "B.Tech AI & ML",
      "B.Tech Data Science", "B.Tech Cyber Security", "B.Tech Cloud Computing",
      "B.Tech ECE", "B.Tech EEE", "B.Tech Mechanical Engineering",
      "B.Tech Civil Engineering", "B.Tech Automobile Engineering",
      "B.Tech Aeronautical Engineering", "B.Tech Aerospace Engineering",
      "B.Tech Chemical Engineering", "B.Tech Petroleum Engineering",
      "B.Tech Biotechnology", "B.Tech Agricultural Engineering",
      "B.Tech Robotics Engineering", "B.Tech Mechatronics",
      "B.Tech Mining Engineering", "B.Tech Marine Engineering",
      "B.Tech Food Technology", "B.Tech Industrial Engineering",
      "B.Tech Environmental Engineering", "B.Tech Textile Engineering",
      "B.Tech Ceramic Engineering", "B.Tech Production Engineering",
      "B.Tech Instrumentation Engineering",
    ],
    "Computer & IT": [
      "BCA", "B.Sc Computer Science", "B.Sc Information Technology",
      "B.Sc AI", "B.Sc Machine Learning", "B.Sc Data Science",
      "B.Sc Cyber Security", "B.Sc Cloud Computing",
      "B.Sc Animation", "B.Sc Game Design",
      "B.Sc Software Engineering", "B.Sc Networking",
      "Bachelor in UI/UX Design", "Bachelor in Web Development",
    ],
    "Science": [
      "B.Sc Physics", "B.Sc Chemistry", "B.Sc Mathematics",
      "B.Sc Statistics", "B.Sc Biotechnology", "B.Sc Microbiology",
      "B.Sc Zoology", "B.Sc Botany", "B.Sc Genetics",
      "B.Sc Environmental Science", "B.Sc Forensic Science",
      "B.Sc Agriculture", "B.Sc Food Science",
      "B.Sc Nutrition & Dietetics", "B.Sc Geography",
      "B.Sc Geology", "B.Sc Astronomy", "B.Sc Oceanography",
    ],
    "Commerce & Business": [
      "B.Com", "B.Com Computers", "B.Com Accounting & Finance",
      "BBA", "BMS", "BFM", "BAF", "BBI", "B.Econ", "BBS",
      "Bachelor in Digital Marketing", "Bachelor in Business Analytics",
      "Bachelor in International Business",
    ],
    "Arts & Humanities": [
      "BA English", "BA History", "BA Political Science",
      "BA Sociology", "BA Psychology", "BA Journalism",
      "BA Philosophy", "BA Economics", "BA Geography",
      "BA Public Administration", "BA Social Work",
      "BA Anthropology", "BA Linguistics",
      "BA Fine Arts", "BA Music", "BA Dance", "BA Theatre Arts",
    ],
    "Medical & Healthcare": [
      "MBBS", "BDS", "BAMS", "BHMS", "BUMS", "BPT", "BOT",
      "B.Pharm", "Pharm D", "B.Sc Nursing", "BMLT",
      "B.Sc Radiology", "B.Sc Optometry",
      "B.Sc Anesthesia Technology", "B.Sc Operation Theatre Technology",
      "B.Sc Cardiology", "B.Sc Dialysis Technology", "B.VSc",
    ],
    "Law": [
      "LLB", "BA LLB", "BBA LLB", "B.Com LLB", "B.Sc LLB",
    ],
    "Education": [
      "B.Ed", "B.P.Ed", "D.El.Ed", "Bachelor in Special Education",
    ],
    "Design & Creative": [
      "B.Des", "BFA", "Bachelor of Fashion Design",
      "Bachelor of Interior Design", "Bachelor of Graphic Design",
      "Bachelor of Animation", "Bachelor of Multimedia",
      "Bachelor of Film Making", "Bachelor of Photography",
    ],
    "Hospitality & Tourism": [
      "BHM", "BTTM", "Bachelor in Aviation Management",
      "Bachelor in Airline Management", "Bachelor in Culinary Arts",
    ],
    "Agriculture & Allied": [
      "B.Sc Agriculture", "B.Sc Horticulture", "B.Sc Forestry",
      "B.Tech Dairy Technology", "B.Fisheries Science", "B.Sc Sericulture",
    ],
  },

  PG: {
    "Engineering & Technology": [
      "M.Tech", "ME", "M.Tech CSE", "M.Tech AI",
      "M.Tech Machine Learning", "M.Tech Data Science",
      "M.Tech Cyber Security", "M.Tech Cloud Computing",
      "M.Tech Robotics", "M.Tech Mechanical Engineering",
      "M.Tech Civil Engineering", "M.Tech ECE",
      "M.Tech Biotechnology", "M.Tech Chemical Engineering",
      "M.Tech Environmental Engineering", "M.Tech Aerospace Engineering",
      "M.Tech Industrial Engineering",
    ],
    "Computer & IT": [
      "MCA", "M.Sc Computer Science", "M.Sc IT",
      "M.Sc AI", "M.Sc Data Science", "M.Sc Cyber Security",
      "M.Sc Cloud Computing", "MS Computer Science",
      "MS Software Engineering", "MS Data Analytics",
    ],
    "Science": [
      "M.Sc Physics", "M.Sc Chemistry", "M.Sc Mathematics",
      "M.Sc Statistics", "M.Sc Biotechnology", "M.Sc Microbiology",
      "M.Sc Zoology", "M.Sc Botany", "M.Sc Genetics",
      "M.Sc Environmental Science", "M.Sc Forensic Science",
      "M.Sc Agriculture", "M.Sc Food Science",
      "M.Sc Nutrition & Dietetics",
    ],
    "Business & Management": [
      "MBA", "PGDM", "M.Com", "MBA HR", "MBA Finance",
      "MBA Marketing", "MBA Operations", "MBA Business Analytics",
      "MBA IT", "MBA International Business",
      "MBA Healthcare Management", "MBA Supply Chain Management",
      "Master in Digital Marketing",
    ],
    "Arts & Humanities": [
      "MA English", "MA History", "MA Political Science",
      "MA Sociology", "MA Psychology", "MA Journalism",
      "MA Economics", "MA Philosophy", "MA Fine Arts",
      "MA Music", "MA Public Administration",
    ],
    "Medical & Healthcare": [
      "MD", "MS Surgery", "MDS", "M.Pharm", "MPT",
      "M.Sc Nursing", "MPH", "Master in Hospital Administration",
      "M.Sc Radiology", "M.Sc Cardiology",
    ],
    "Law": [
      "LLM", "LLM Corporate Law", "LLM Criminal Law", "LLM International Law",
    ],
    "Education": [
      "M.Ed", "M.P.Ed", "MA Education", "Master in Special Education",
    ],
    "Design & Creative": [
      "M.Des", "MFA", "Master in Animation", "Master in Fashion Design",
      "Master in Interior Design", "Master in Graphic Design",
      "Master in Film Making",
    ],
    "Hospitality & Tourism": [
      "MHM", "MTTM", "MBA Aviation Management", "Master in Culinary Arts",
    ],
    "Agriculture & Allied": [
      "M.Sc Agriculture", "M.Sc Horticulture", "M.Sc Forestry",
      "M.Tech Dairy Technology", "M.Fisheries Science",
    ],
  },
};

// 3️⃣  FIELD_OF_STUDY_BY_PROGRAM  — dropdown options in Step 3
const FIELD_OF_STUDY_BY_PROGRAM = {
  UG: [
    "Engineering & Technology",
    "Computer & IT",
    "Science",
...
// ─────────────────────────────────────────────────────────────────────────────
// COURSE COUNTS SUMMARY (for reference)
// UG Total: 30 + 14 + 18 + 13 + 17 + 18 + 5 + 4 + 9 + 5 + 6 = 139 courses
// PG Total: 17 + 10 + 14 + 13 + 11 + 10 + 4 + 4 + 7 + 4 + 5 = 99  courses
// Grand Total: 238 courses
// ─────────────────────────────────────────────────────────────────────────────

// ── Separate course pools for UG and PG ──────────────────────────────────────


// Flat list per program type for suggestions
const getCourseList = (programType) => {
  const pool = COURSES_BY_PROGRAM[programType] || COURSES_BY_PROGRAM.UG;
...
const findCourseSegment = (courseName = '', programType = 'UG') => {
  const normalizedName = normalizeCourseText(courseName);
  if (!normalizedName) return '';

  const pool = COURSES_BY_PROGRAM[programType] || {};
  for (const [segmentName, courses] of Object.entries(pool)) {
    if (courses.some(course => {
      const normalizedCourse = normalizeCourseText(course);
      return normalizedCourse && (
        normalizedName === normalizedCourse ||
        normalizedName.includes(normalizedCourse) ||
        normalizedCourse.includes(normalizedName)
      );
    })) {
      return segmentName;
    }
  ...
  const keywordGroups = [
    ['Computer & IT', ['computer', 'information technology', 'software', 'data science', 'data analytics', 'artificial intelligence', 'machine learning', 'cyber', 'cloud', 'network', 'web', 'ui ux', 'game', 'animation', 'bca', 'mca']],
    ['Engineering & Technology', ['engineering', 'technology', 'mechanical', 'electrical', 'electronics', 'civil', 'robotics', 'chemical', 'aerospace', 'aeronautical', 'petroleum', 'biotechnology', 'mining', 'marine', 'automobile', 'mechatronics', 'industrial', 'instrumentation', 'ece', 'eee', 'cse']],
    ['Business & Management', ['business', 'management', 'mba', 'pgdm', 'commerce', 'finance', 'marketing', 'accounting', 'economics', 'supply chain', 'human resource', 'operations']],
    ['Commerce & Business', ['commerce', 'business', 'finance', 'accounting', 'economics', 'marketing']],
    ['Science', ['physics', 'chemistry', 'mathematics', 'statistics', 'microbiology', 'zoology', 'botany', 'genetics', 'environmental science', 'forensic', 'geology', 'astronomy', 'oceanography', 'nutrition']],
    ['Medical & Healthcare', ['medical', 'health', 'medicine', 'nursing', 'pharmacy', 'pharm', 'radiology', 'cardiology', 'physiotherapy', 'surgery', 'dental', 'hospital']],
    ['Law', ['law', 'llb', 'llm']],
    ['Education', ['education', 'teaching', 'pedagogy']],
    ['Design & Creative', ['design', 'creative', 'fashion', 'interior', 'graphic', 'film', 'photography', 'fine arts', 'multimedia']],
    ['Hospitality & Tourism', ['hospitality', 'tourism', 'hotel', 'aviation', 'culinary', 'airline']],
    ['Agriculture & Allied', ['agriculture', 'horticulture', 'forestry', 'fisheries', 'dairy', 'sericulture']],
  ];

  const match = keywordGroups.find(([, keywords]) =>
    keywords.some(keyword => normalizedName.includes(normalizeCourseText(keyword)))
  );
  return match?.[0] || '';
};

const SEGMENT_ALIASES = {
  'computer and it': ['computer and it', 'computer science and it', 'computer science', 'information technology'],
  'engineering and technology': ['engineering and technology', 'engineering', 'technology'],
  'business and management': ['business and management', 'commerce and business', 'business', 'management'],
  'commerce and business': ['commerce and business', 'business and management', 'commerce', 'business'],
  'medical and healthcare': ['medical and healthcare', 'medical and health sciences', 'medical', 'health', 'healthcare'],
  'arts and humanities': ['arts and humanities', 'arts', 'humanities', 'media and communications'],
  'design and creative': ['design and creative', 'architecture and design', 'design', 'creative'],
  'science': ['science', 'natural sciences'],
  'law': ['law'],
  'education': ['education'],
  'hospitality and tourism': ['hospitality and tourism', 'hospitality', 'tourism'],
  'agriculture and allied': ['agriculture and allied', 'agriculture'],
};

const segmentNamesMatch = (courseArea = '', selectedArea = '') => {
  const normalizedCourseArea = normalizeCourseText(courseArea);
  const normalizedSelectedArea = normalizeCourseText(selectedArea);
  if (!normalizedCourseArea || !normalizedSelectedArea) return false;
  if (normalizedCourseArea === normalizedSelectedArea) return true;

  const aliases = SEGMENT_ALIASES[normalizedSelectedArea] || [normalizedSelectedArea];
  return aliases.some(alias => normalizeCourseText(alias) === normalizedCourseArea);
};

const inferSegmentFromInterestedCourses = (courses = [], programType = 'UG') => {
  const counts = new Map();
  courses.forEach(course => {
    const segment = findCourseSegment(course, programType);
...
const courseMatchesSegment = (course, segmentName, programType = 'UG') => {
  if (!segmentName) return true;
  const explicitArea = course.majorArea || course.field || course.category || course.stream || '';
  const inferredArea = explicitArea || findCourseSegment(course.title || course.name || course.program_name, programType);
  return segmentNamesMatch(inferredArea, segmentName);
};

const COURSE_MATCH_STOPWORDS = new Set([
  'm', 'msc', 'ms', 'mtech', 'tech', 'me', 'master', 'masters', 'b', 'bsc', 'btech',
  'be', 'bachelor', 'degree', 'program', 'course', 'engineering', 'technology',
  'science', 'sciences', 'and', 'of', 'in',
]);

const COURSE_TOKEN_ALIASES = {
  ...
  web: ['web', 'website', 'frontend', 'front', 'development'],
  development: ['development', 'developer', 'web', 'software'],
  ui: ['ui', 'ux', 'user', 'interface', 'experience', 'design'],
  ux: ['ux', 'ui', 'user', 'experience', 'interface', 'design'],
  software: ['software', 'development', 'programming'],
  computer: ['computer', 'computing', 'cs'],
  information: ['information', 'it'],
  data: ['data'],
  machine: ['machine'],
  learning: ['learning'],
};

const getCourseTokens = (value = '') =>
  normalizeCourseText(value)
    .split(' ')
    .filter(token => token && !COURSE_MATCH_STOPWORDS.has(token));

const courseMatchesInterest = (course, interest = '') => {
  const courseName = course.title || course.name || course.program_name || '';
  const courseNormalized = normalizeCourseText(courseName);
  const interestNormalized = normalizeCourseText(interest);
  if (!courseNormalized || !interestNormalized) return false;
  if (courseNormalized === interestNormalized) return true;

  const courseTokens = new Set(getCourseTokens(courseName));
  const interestTokens = getCourseTokens(interest);
  if (!interestTokens.length) return false;

  return interestTokens.every(token => {
    const aliases = COURSE_TOKEN_ALIASES[token] || [token];
    return aliases.some(alias => courseTokens.has(alias));
  });
};

// Field of Study options per segment / program
...
.course-category-grid{display:flex;flex-direction:column;gap:1rem;margin-top:.5rem}
.course-category-block{background:#f8fafc;border:1px solid #e2e8f0;border-radius:12px;padding:.875rem 1rem}
.course-category-title{font-size:.75rem;font-weight:700;color:#475569;text-transform:uppercase;letter-spacing:.5px;margin-bottom:.6rem}
.course-quick-chips{display:flex;flex-wrap:wrap;gap:.4rem}
.course-quick-chip{padding:.3rem .8rem;border-radius:999px;border:1.5px solid #e2e8f0;background:#fff;font-size:.75rem;font-weight:500;color:#475569;cursor:pointer;transition:all .15s}
...
// ─────────────────────────────────────────────────────────────────────────────
const normalizeUniversity = (uni, forcedSource) => {
  let resolvedSource = forcedSource;
  if (!resolvedSource) {
    if (uni.degree === 'master' || uni.educationLevel === 'Postgraduate' || uni.universityType === 'Master') {
      resolvedSource = 'masters';
    } else {
      resolvedSource = 'bachelors';
    }
  }
  ...
  const city         = uni.CITY        || uni.city           || locationObj.city  || flatLocation || '';
  const state        = uni.STABBR      || uni.state          || locationObj.state || '';
  const explicitCountry = uni.country || locationObj.country || uni.COUNTRY || '';
  const country      = explicitCountry || flatLocation || 'USA';
  const displayLocation = locationObj.display || [city, state].filter(Boolean).join(', ') || flatLocation || explicitCountry;
...
localStorage.setItem('userProfile', JSON.stringify(p));
  ...
  useEffect(() => {
    ...
    const effectiveSegmentName = getEffectiveSegmentName();
    if (effectiveSegmentName) {
      filtered = filtered.filter(u => getCoursesForSegment(universityCourses[getUniKey(u)] || buildCourses(u)).length > 0);
    }
    if (searchTerm.trim()) {
      ...
      filtered = filtered.filter(u =>
        ...
        (u.location?.display || '').toLowerCase().includes(t) ||
        (u.location?.country || u.country || u.COUNTRY || '').toLowerCase().includes(t) ||
        (u._normalizedId || '').toLowerCase().includes(t)
      );
    }
    setFilteredUniversities(filtered);
  }, [searchTerm, universities, selectedSegment, universityCourses, education.field, interestedCourses, programType]); // eslint-disable-line react-hooks/exhaustive-deps
  ...
  useEffect(() => {
    ...
    const pool = getCourseList(programType);
  ...
  }, [reqCourseInput, reqCourses, programType]);
  ...
  useEffect(() => {
    ...
    const allCoursePool = COURSES_BY_PROGRAM[programType || 'UG'] || {};
    const courseCategory = education.field || selectedSegment?.name || '';
    const scopedPool = courseCategory
      ? Object.entries(allCoursePool)
          .filter(([category]) => segmentNamesMatch(category, courseCategory))
          .flatMap(([, courses]) => courses)
      : Object.values(allCoursePool).flat();
    const pool = scopedPool.length ? scopedPool : getCourseList(programType || 'UG');
  ...
  }, [courseInterestInput, interestedCourses, programType, education.field, selectedSegment]);
  ...
  const fetchUniversities = useCallback(async () => {
    ...
    try {
      const res = await axiosInstance.get('/api/admin/universities', {
        params: {
          stream:      programType,
          type:        programType === 'PG' ? 'masters' : 'bachelors',
      ...
      if (Array.isArray(res.data.data)) {
        ...
        rawList = programType === 'PG'
          ? (res.data.data.masters   || res.data.data.postgraduate || [])
          : (res.data.data.bachelors || res.data.data.undergraduate || []);
        if (rawList.length === 0) {
          rawList = [
            ...(res.data.data.bachelors || []),
            ...(res.data.data.masters   || []),
          ];
        }
      }
      ...
      for (const u of rawList) {
        const norm = normalizeUniversity(u, forcedSource);
    ...
    return (university.programs || []).map((p, i) => {
      if (typeof p === 'string') {
        return {
          ...
          majorArea: findCourseSegment(p, programType) || 'General',
          description: `${p} at ${university.INSTNM}`,
        };
      }
      const name = p.name || p.title || p.program_name || `Program ${i + 1}`;
      const majorArea = p.majorArea || p.field || p.category || p.stream || findCourseSegment(name, programType) || '';
      return {
  ...
  const getEffectiveSegmentName = () =>
    selectedSegment?.name || education.field || inferSegmentFromInterestedCourses(interestedCourses, programType);

  const getCoursesForSegment = (courses) => {
    const segmentName = getEffectiveSegmentName();
    if (!segmentName) return courses;
    return courses.filter(c => courseMatchesSegment(c, segmentName, programType));
  };
  ...
  const keepInterestedCoursesForCategory = (segmentName) => {
    if (!segmentName) return;
    setInterestedCourses(prev =>
      prev.filter(course => segmentNamesMatch(findCourseSegment(course, programType), segmentName))
    );
  };
  ...
  const openCourseModal = (uni) => {
    ...
    if (!allCourses.length) {
      setError(`No courses found for ${fresh.INSTNM || fresh.name || 'this university'}`);
      setTimeout(() => setError(''), 2200);
      return;
    }

    const segmentCourses = getCoursesForSegment(allCourses);
    const baseCourses = segmentCourses.length ? segmentCourses : allCourses;
    const interestMatchedCourses = interestedCourses.length > 0
      ? baseCourses.filter(course =>
          interestedCourses.some(interest => courseMatchesInterest(course, interest))
        )
      : [];
    const finalCourses = interestMatchedCourses.length ? interestMatchedCourses : baseCourses;
    const notice = interestedCourses.length > 0 && !interestMatchedCourses.length
      ? `Your selected courses are not available at ${fresh.INSTNM || fresh.name || 'this university'}. These are the courses this university offers.`
      : '';
  ...
  const toggleUniversity = (uni) => {
    ...
    if (isSel) {
      ...
      } else if (!getCoursesForSegment(courses).length) {
        setError(`No ${getEffectiveSegmentName() || 'matching'} courses found for this university`);
        setTimeout(() => setError(''), 2200);
      } else {
  ...
  const validateStep3 = () => {
    ...
    // ✅ FIX: field is now optional — remove required validation
    setValidationErrors(e); return !Object.keys(e).length;
  };
  const validateStep4 = () => {
  ...
  const handleSubmitProfile = async () => {
    ...
    try {
      ...
      formattedUniversities = selectedUniversities.map(u => {
        ...
        const resolvedId = (
          u.id || u.UNITID?.toString() || u.universityCode || u._id?.toString() ||
          u._normalizedId || `uni-${Date.now()}-${Math.random().toString(36).substr(2, 6)}`
        );
        const resolvedName = (u.INSTNM || u.universityName || u.name || '').trim() || 'Unknown University';
  ...
  fixedEducation.field ? { id: fixedEducation.field.toLowerCase().replace(/\s+/g, '-'), name: fixedEducation.field } : null
);
...
const profileData = {
  ...
  interestedCourses:    interestedCourses.filter(Boolean),
  ...
  completedAt:          new Date().toISOString(),
      ...
      if (res.data.success) {
        const sk = sessionStorage.getItem('sessionKey');
        if (sk) {
          localStorage.setItem(`userProfile_${sk}`, JSON.stringify(profileData));
          localStorage.setItem(`profileCompleted_${sk}`, 'true');
        } else {
   ...
   const fallbackData = {
  basicInfo,
  education: { ...education, field: education.field || '', qualification: programType === 'UG' ? '12th' : 'Bachelor' },
  programType,
  selectedSegment,
  segment: selectedSegment?.name || null,
  interestedCourses,
  selectedUniversities: formattedUniversities,
  profileCompleted: true,
};
      const sk = sessionStorage.getItem('sessionKey');
      if (sk) {
        localStorage.setItem(`userProfile_${sk}`, JSON.stringify(fallbackData));
        localStorage.setItem(`profileCompleted_${sk}`, 'true');
      } else {
  ...
  const coursePool = programType ? COURSES_BY_PROGRAM[programType] : {};
  const fieldOptions = programType ? FIELD_OF_STUDY_BY_PROGRAM[programType] : [];
  const visibleCourseCategory = education.field || selectedSegment?.name || '';
  const visibleCoursePoolEntries = visibleCourseCategory
    ? Object.entries(coursePool).filter(([category]) => segmentNamesMatch(category, visibleCourseCategory))
    : Object.entries(coursePool);
        ...
        {step === 3 && (
          <div className="form-card userprofile-fade-in">
            ...
            <div className="form-fields">
              ...
              {/* ✅ FIX: Field of Study — dropdown filtered by programType */}
              <div className="form-row">
                <label>
                  Field of Study
                ...
                <div className="field-select-wrapper">
                  <select
                    ...
                    onChange={e => {
                      ...
                      setEducation({ ...education, field: nextField });
                      syncSegmentFromName(nextField, true);
                      keepInterestedCoursesForCategory(nextField);
                    }}
                  >
                ...
                <span className="email-note">
                  {programType === 'PG' ? 'Your Master\'s / MBA specialisation area' : 'Your Bachelor\'s field of study'}
                </span>
              </div>
                      ...
                      return (
                        <button key={seg.id} className={`segment-chip ${activeClass}`}
                          onClick={() => {
                            ...
                            if (!isActive) keepInterestedCoursesForCategory(seg.name);
                          }}>
                          {seg.name}{isActive && ' ✕'}
                        </button>
                      );
              ...
              <div className="form-row">
                ...
                {interestedCourses.length < 5 && (
                  <div className="course-category-grid">
                    {visibleCoursePoolEntries.map(([category, courses]) => (
                      <div key={category} className="course-category-block">
                        <div className="course-category-title">{category}</div>
                        <div className="course-quick-chips">
                          {courses.map(course => {
                            const isSelected = interestedCourses.includes(course);
                            return (
                              <button
                                key={course}
                                type="button"
                                ...
                                onClick={() => {
                                  if (isSelected) {
                                    setInterestedCourses(prev => prev.filter(c => c !== course));
                                  } else if (interestedCourses.length < 5) {
                                    setInterestedCourses(prev => [...prev, course]);
                                    syncSegmentFromName(category);
                                  }
                                }}
                              >
                ...
                <div style={{ position: 'relative', marginTop: 10 }}>
                  ...
                  >
                    {interestedCourses.length < 5 ? (
                      <input
                        ...
                        placeholder="Or type a custom course and press Enter…"
                        autoComplete="off"
                        ...
                        onKeyDown={e => {
                          if (e.key === 'Enter' || e.key === ',') {
                            ...
                            syncSegmentFromName(findCourseSegment(val, programType));
                  ...
                  <span style={{ fontSize: 11, color: '#94a3b8', marginTop: 4, display: 'block' }}>
                    Click chips above to select &middot; or type custom &middot; Press <strong>Enter</strong> to add
                  </span>
                        ...
                        return (
                          <button key={i} type="button"
                            ...
                            onMouseDown={() => {
                              ...
                              syncSegmentFromName(findCourseSegment(suggestion, programType));
                              setCourseInterestInput(''); setCourseInterestSuggest([]); setShowCourseInterestDdp(false);
                              setTimeout(() => courseInterestInputRef.current?.focus(), 0);
                            }}>
                            {idx === -1 ? suggestion : (
                              <>{suggestion.slice(0, idx)}<strong style={{ color: accentHl }}>{suggestion.slice(idx, idx + t.length)}</strong>{suggestion.slice(idx + t.length)}</>
                            )}
                          </button>
                        );
                      })}
              ...
              <>
                <div className="universities-grid">
                  {filteredUniversities.length > 0 ? filteredUniversities.map(uni => {
                    const key        = getUniKey(uni);
                    const isSel      = selectedUniversities.some(u => getUniKey(u) === key);
                    const allCourses = universityCourses[key] || buildCourses(uni);
                    const progCount  = getCoursesForSegment(allCourses).length;
                        ...
                        >
                          ...
                          <div className="university-details">
                            ...
                            <p className="uni-location">
                              {uni.location?.display || 'Location N/A'}
                            </p>
          ...
          <div className="form-card userprofile-fade-in">
            ...
            <div className="review-section">
              ...
              <div className="review-grid">
                ...
                {selectedSegment && <p><strong>Segment:</strong> <span style={{ color: accentColor }}>{selectedSegment.name}</span></p>}
                {interestedCourses.length > 0 && (
        ...
        <div className="modal-overlay" onClick={closeCourseModal}>
          <div className="modal-content course-modal" onClick={e => e.stopPropagation()}>
            ...
            <div className="modal-body">
              ...
              {getEffectiveSegmentName() && (
                <p className="course-segment-note">
                  Showing courses for <strong>{getEffectiveSegmentName()}</strong>
                </p>
              )}
              {courseModalNotice && (
