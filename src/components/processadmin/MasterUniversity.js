...
/* ─────────────────────────────────────────────────────────────────────────────
   API CONFIG
───────────────────────────────────────────────────────────────────────────── */
const API_BASE = `${API_BASE_URL}/api/master-university`;
...
const DetailModal = ({ studentId, onClose }) => {
          ...
          <div key={key} className="modal-doc-row">
            ...
            <div className="modal-doc-actions">
              ...
              {doc.uploaded && (doc.fileUrl || doc.fileKey) && (
                <a
                  href={resolveFileUrl(doc.fileKey || doc.fileUrl)}
                  target="_blank"
                  rel="noreferrer"
  ...
  return (
    <div className="modal-overlay" onClick={(e) => e.target === e.currentTarget && onClose()}>
      <div className={`modal-box modal-box-${activeTab}`}>
        {detail && (
          <>
            {/* Header */}
            ...
            {/* Tab content */}
            <div className={`modal-content modal-content-${activeTab}`}>
