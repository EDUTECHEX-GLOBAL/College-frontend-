...
const loadApplications = useCallback(async () => {
  ...
  residencyRes // ✅ add this
    ...
    const mappedGeneral = generalRecords.map((app) => ({
      ...
      details: {
        startTerm: app.startTerm || "N/A",
        housingPreference: app.housingPreference || "N/A",
        participationPrograms: app.participationPrograms || "N/A",
        fafsaIntent: app.fafsaIntent || "N/A",
        visaClassification: app.visaClassification || "N/A",
  ...
  type: "residency",
    ...
    setStats({
      ...
      accepted: combined.filter((a) => a.status === "accepted").length,
      rejected: combined.filter((a) => a.status === "rejected").length,
      incomplete: combined.filter(
              ...
              <tr key={app._id}>
                ...
                <td>
                  <div className="progress-container">
                    <div
                      className={`progress-bar progress-${getProgressClass(
                        app.progress
                      )}`}
          ...
          <div className="modal-box">
            ...
            <div className="modal-content">
              ...
              <div className="info-section">
                ...
                <div className="info-grid">
                  ...
                  <div className="info-row">
                    ...
                    <span className="info-value">{selectedApp._id}</span>
                  </div>
                  <div className="info-row">
                  ...
                  <div className="info-row">
                    ...
                    <span className="info-value">{selectedApp.progress}%</span>
                  </div>
                  <div className="info-row">
              ...
              <div className="info-section">
                ...
                <div className="info-grid">
                  {Object.entries(selectedApp.details
)
